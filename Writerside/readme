...
textgeneratorr3k.model: Pretrained model for generating poetry.
...
Loads the pretrained model (commented out by default).
...
To generate poetry, uncomment the section labeled "Uncomment when creating a new file" to create a new dataset and train the model. Similarly, uncomment the section labeled "uncomment when parsing file" to load a pretrained model and generate poetry.
